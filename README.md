...
Deleted a recording by mistake? **Trash** holds it until you restore it or empty it — nothing is
gone the instant you press delete.
...
- **Only transcript text is sent, and only for notes** — to the LM Studio endpoint you configure,
  loopback (`127.0.0.1`) by default. Recording and transcription work with LM Studio never
  running.
